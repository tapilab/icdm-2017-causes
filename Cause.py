...
"""
def construct_feature_matrix(text_list, mytokenizer = tw_tokenize_with_features,flag = "ct"):
    vectorizer = CountVectorizer(stop_words = 'english',tokenizer = mytokenizer)
...
def healthbrand_comt_predict_matrix(tweet_list,entity,entity_nameID,eco_terms,GN_model,health_keywords,comt_mention1_vectorizer,comt_mentionAllpron_vectorizer,comt_topn_vectorizer):
    ...
    BOW_self_tweet_once = Cause.selfmention([entity],healthbrand_nameid,tweet_list, count="once")
...
def healthbrand_predict_label_2_3(comt_clf,entity_nameID,eco_terms,comt_mention1_vectorizer,comt_mentionAllpron_vectorizer,comt_topn_vectorizer,tweet_file,resfile):
    n=0
